...
public class AccuWeatherModel implements WeatherModel {
    ...
    public void getWeather(Input input, String selectedCity) throws IOException {
    ...
    public void getExit(Input input) {
        if (input == Input.EXIT) {
    ...
    @Override
    public void getSavedWeatherData(Input input) throws SQLException {
        if (input == Input.SAVE_DATA) {
            DataBaseRepository dataBaseRepository = new DataBaseRepository();
            dataBaseRepository.getSavedWeatherData();
            //TODO: Обратиться к  DataBaseRepository и вызвать метод getSavedWeatherData (реализовал)
        }
    }
